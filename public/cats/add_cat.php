		...
		<div id="contenu">
			...
			<form action="champs_add_cat.php" method="post" name="Ajout">
				...
				<table>
					...
					<td><select name="pattern" id="pattern" size="30">
						<?php 
						...
						$patterns = $connexion -> query("SELECT name_pattern FROM Patterns WHERE id_user = ");
					...
					<td><select name="sexe" id="sexe" size="30">
					...
					<td><select name="coat" id="coat" size="30">
					...
					<td><select name="size" id="size" size="30">
