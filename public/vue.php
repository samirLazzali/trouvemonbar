...
{
	echo"<header class=\"container clearfix\">

        <div class=\"caddie\"></div>
				<h1 class=\"titre\">Dans ton caddie !</h1>";

	if ($pseudo == NULL){
  echo"<div onClick=\"window.location='inscription.php';\" class=\"inscription inscription-1 clearfix\">
	...
	echo"<div onClick=\"window.location='deconnexion.php';\" class=\"inscription inscription-1 clearfix\">
	<p class=\"inscription\">Deconnexion</p>
	</div>";
	}
	echo"<nav class=\"menu clearfix\">
          ...
          <div onClick=\"window.location='recette.php';\" class=\"hasard hasard-1 clearfix\">
            <div class=\"hasard\">
              <p>Recette au hasard</p>
            </div>
          </div>
          
          <div onClick=\"window.location='menu.php';\" class=\"catalogue catalogue-1 clearfix\">
            <p class=\"catalogue\">Menu</p>
					</div>";
					
	if ($pseudo != NULL){
	echo "<div onClick=\"window.location='profil.php';\" class=\"profil profil-1 clearfix\">
