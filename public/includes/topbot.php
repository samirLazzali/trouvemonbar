  ...
  <body>
	...
	<?php	
	 ...
	 ?>
      ...
      <a href="<?php echo ROOTPATH; ?>/cats/search_cat.php">Mes recherches</a>   &nbsp;
      <a href="<?php echo ROOTPATH; ?>/membres/matcher.php">Matcher mes chats</a>   &nbsp;
      <a href="<?php echo ROOTPATH; ?>/membres/deconnexion.php">Se déconnecter</a>
      <?php 
	      if($fetch->user_type == 0) { ?>
	      <a href="<?php echo ROOTPATH; ?>/admin/crud.php">Administration</a>   &nbsp; <?php
		 }
	}
