...
L'utilisateur a la possibilité de modifier son profil quand il le souhaite, pour cela il doit se rendre sur la page Modifier_profil.php accessible depuis la barre de navigation.
